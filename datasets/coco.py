...
def build(image_set, args):
    ...
    # #configurations to train on citypersons
    # PATHS = {
    #     "train": (root /"", root /'train.json'),
    #     "train_reg": (root /"", root /'train.json'),
    #     "val": (root / "leftImg8bit_trainvaltest/leftImg8bit/val_all_in_folder", root /'val_gt_for_mmdetction.json'),
    #     "eval_debug": (root / "leftImg8bit_trainvaltest/leftImg8bit/val_all_in_folder", root /'val_gt_for_mmdetction.json'),
    #     "test": (root / "leftImg8bit_trainvaltest/leftImg8bit/val_all_in_folder", root /'val_gt_for_mmdetction.json'),
    # }

    #configurations to train on TJU-Ped-Traffic
    # PATHS = {
    #     "train": (root /"dhd_traffic/images/train", root /'dhd_pedestrian/ped_traffic/annotations/dhd_pedestrian_traffic_train.json'),
    #     "train_reg": (root /"dhd_traffic/images/train", root /'dhd_pedestrian/ped_traffic/annotations/dhd_pedestrian_traffic_train.json'),
    #     "val": (root / "dhd_traffic/images/val", root /'dhd_pedestrian/ped_traffic/annotations/dhd_pedestrian_traffic_val.json'),
    #     "eval_debug": (root / "dhd_traffic/images/val", root /'dhd_pedestrian/ped_traffic/annotations/dhd_pedestrian_traffic_val.json'),
    #     "test": (root / "dhd_traffic/images/val", root /'dhd_pedestrian/ped_traffic/annotations/dhd_pedestrian_traffic_val.json'),
    # }

    # #configurations to train on TJU-Ped-Campus
    # PATHS = {
    #     "train": (root /"dhd_campus_train_images/dhd_campus/images/train", root /'dhd_pedestrian/ped_campus/annotations/dhd_pedestrian_campus_train.json'),
    #     "train_reg": (root /"dhd_campus_train_images/dhd_campus/images/train", root /'dhd_pedestrian/ped_campus/annotations/dhd_pedestrian_campus_train.json'),
    #     "val": (root / "dhd_campus_train_images/dhd_campus/images/val", root /'dhd_pedestrian/ped_campus/annotations/dhd_pedestrian_campus_val.json'),
    #     "eval_debug": (root / "dhd_campus_train_images/dhd_campus/images/val", root /'dhd_pedestrian/ped_campus/annotations/dhd_pedestrian_campus_val.json'),
    #     "test": (root / "dhd_campus_train_images/dhd_campus/images/val", root /'dhd_pedestrian/ped_campus/annotations/dhd_pedestrian_campus_val.json'),
    # }

    # #configurations to train caltech
    # PATHS = {
    #     "train": (root /"caltech-train-single_folder/", root /'caltech-train-test-split/train.json'),
    #     "train_reg": (root /"caltech-train-single_folder/", root /'caltech-train-test-split/train.json'),
    #     "val": (root / "custom_caltech/val", root /'caltech-train-test-split/test.json'),
    #     "eval_debug": (root / "custom_caltech/val", root /'caltech-train-test-split/test.json'),
